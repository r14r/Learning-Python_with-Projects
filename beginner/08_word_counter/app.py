...
def main():
    """Main function to demonstrate word counting."""
...
Hello Python world"""
    ...
    print(f"Characters (with spaces): {count_characters(sample_text, True)}")
    print(f"Characters (without spaces): {count_characters(sample_text, False)}")
    print(f"Lines: {count_lines(sample_text)}")
    print(f"\nWord frequency: {word_frequency(sample_text)}")
